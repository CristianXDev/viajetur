    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0"><i class="fas fa-plane"></i> MIS PAQUETES RESERVADOS</h4>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="table-responsive">
                <table class="table table-light table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th class="col-md-3">{{ strtoupper($proforma->paquete->nombre) }}</th>
                            ...
                            <th class="col-md-2">{{$proforma->paquete->precio}}$</th>
                            <th class="col-md-2">
