...
<title>VIAJETUR | ¡CREAR UN NUEVO HOTEL!</title>
...
<div class="wrapper">
    <form action="{{url('/hotel/')}}" method="POST" class="content-wrapper" enctype="multipart/form-data">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0"><i class="fas fa-hotel"></i> CREAR UN NUEVO HOTEL</h4>
                    </div>
                    <div class="col-sm-6">
