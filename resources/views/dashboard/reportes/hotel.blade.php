...
<div class="wrapper">
		...
		<div class="container">
			<div class="content-header mb-4">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h4 class="m-0"><i class="fas fa-hotel"></i> REPORTE DE HOTELES</h4>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="container mt-5">
		<div class="col-md-8 mx-auto">
			<form action="{{ route('reporte_hotel_pdf') }}" method="POST" class="card card-primary">
...
-->
					...
					<div class="input-group mb-3">
						...
						<select name="proveedor" class="form-control">
							...
							<option value="{{$hotel->user->id}}">{{$hotel->user->nombre}}</option>
							@endforeach
						</select>
					</div>
